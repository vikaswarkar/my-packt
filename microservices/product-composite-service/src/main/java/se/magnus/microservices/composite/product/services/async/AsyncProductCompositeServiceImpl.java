...
import se.magnus.api.composite.product.AsyncProductCompositeService;
...
@RestController
@Slf4j
public class AsyncProductCompositeServiceImpl implements AsyncProductCompositeService {

    private final AsyncProductCompositeIntegration integration;
    private final ServiceUtil serviceUtil;

    public AsyncProductCompositeServiceImpl(AsyncProductCompositeIntegration integration, ServiceUtil serviceUtil) {
